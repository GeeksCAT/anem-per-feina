...
class Job(models.Model):
    ...
    title = models.CharField(max_length=300, verbose_name=_('Title'),
                             help_text=_('Short job title.'))
    description = models.TextField(verbose_name=_('Description'),
                                   help_text=_('Long job description.'))
    location = models.CharField(max_length=150, verbose_name=_('Location'), 
                                help_text=_('Location for this job position.'))
    type = models.CharField(choices=JOB_TYPES, max_length=10, verbose_name=_('Type'), 
    ...
    company_name = models.CharField(max_length=100, verbose_name=_('Company'),
                                    help_text=_("Job's Company name."))
    company_description = models.CharField(max_length=300, verbose_name=_('Company description'),
                                           help_text=_('Company description, activity,...'))
    website = models.CharField(max_length=100, default="", verbose_name=_('Website'), 
                               help_text=_('Company Website URL.'))
    created_at = models.DateTimeField(default=timezone.now, verbose_name=_('Created'), 
                                      help_text=_('Job creation date and time.'))
    filled = models.BooleanField(default=False, verbose_name=_('Filled'), 
                                 help_text=_('Job position is filled.'))
...
class Applicant(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name=_('User'), 
                             help_text=_('User applicant.') )
    job = models.ForeignKey(Job, on_delete=models.CASCADE, related_name='applicants', 
                            verbose_name=_('Job'), help_text=_('Job in applicant.'))
    created_at = models.DateTimeField(default=timezone.now, verbose_name=_('Created'),
